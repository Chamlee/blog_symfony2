...
namespace Chamlee\BlogBundle\DataFixtures\ORM;
...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    */
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setBlog('Lor or qazer ze xsdgs dfgs dfgs dfgsdf lectus convallis nunc, vel scelerisque lorem tortor ac nunc. Donec pharetra eleifend enim vel porta.');
        $blog1->setImage('binary.jpg');
        ...
        $blog2->setBlog('Vestibulum vulputate mauris eget erat congue dapibus imperd. Morbi id quam nisl. Praesent hendrerit, orci sed elementum lobortis.');
        $blog2->setImage('grid.jpg');
